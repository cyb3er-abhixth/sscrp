...
const departments = [
  {
    ...
    blurb: "Frontline patrol officers responding to incidents across River City and surrounds. Non-WL. Sub-division:Highway patrol, pursuit and traffic enforcement on the Highway 55.",
    ranks: ["Chief Superintendent", "Superindendent", "Chief inspector", "Inspector", "Senior Seargeant", "Seargeant", "Senior Constable", "Constable", "Probationary Constable"],
  ...
  },
  {
    ...
    ranks: ["Commander", "Superintendent", "Inspector", "Sergeant", "Leading Senior Constable", "Senior Constable", "First Constable", "Constable","Recruit"],
